---
id: optimizer-rule-opt-exists-subquery-to-table-join-rewrite
...
localeOf: en-optimizer-rule-opt-exists-subquery-to-table-join-rewrite
subtype: rule
language: zh
...
| 字段 | 值 |
|---|---|
| 规则 ID | opt-exists-subquery-to-table-join-rewrite |
