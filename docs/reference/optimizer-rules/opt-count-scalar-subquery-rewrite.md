---
id: optimizer-rule-opt-count-scalar-subquery-rewrite
title: COUNT 标量子查询重写
type: reference
status: draft
owners: []
...
localeOf: en-optimizer-rule-opt-count-scalar-subquery-rewrite
subtype: rule
language: zh
...
| 字段 | 值 |
|---|---|
| 规则 ID | opt-count-scalar-subquery-rewrite |
| 规则名称 | COUNT 标量子查询重写 |
| 类别 | rewrite（重写） |
| 预警级别 | 提示 |
| 适用数据库 | 待验证（尚未声明数据库范围） |
