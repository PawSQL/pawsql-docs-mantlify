---
id: audit-rule-aud-order-by-forbidden-in-updatedelete
...
localeOf: en-audit-rule-aud-order-by-forbidden-in-updatedelete
subtype: rule
language: zh
...
| 字段 | 值 |
|---|---|
| 规则 ID | aud-order-by-forbidden-in-updatedelete |
