---
id: audit-rule-aud-avoid-unconditional-updatedelete-statements
...
localeOf: en-audit-rule-aud-avoid-unconditional-updatedelete-statements
subtype: rule
language: zh
...
| 字段 | 值 |
|---|---|
| 规则 ID | aud-avoid-unconditional-updatedelete-statements |
