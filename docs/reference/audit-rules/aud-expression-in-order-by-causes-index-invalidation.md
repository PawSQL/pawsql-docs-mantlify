---
id: audit-rule-aud-expression-in-order-by-causes-index-invalidation
...
localeOf: en-audit-rule-aud-expression-in-order-by-causes-index-invalidation
subtype: rule
language: zh
...
| 字段 | 值 |
|---|---|
| 规则 ID | aud-expression-in-order-by-causes-index-invalidation |
