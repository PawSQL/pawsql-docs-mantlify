...
<Frame caption="Select a workspace, or create one from DDL or a database connection">
  <img src="/images/quickstart/01-workspace.png" alt="Create a workspace: choose a database type and import DDL or connect a database" />
</Frame>
...
<Frame caption="Confirm the workspace and schema, then submit the query">
  <img src="/images/quickstart/02-submit-sql.png" alt="Paste the sample query into the SQL editor before optimizing" />
</Frame>
...
<Frame caption="Open the detailed findings, rewrite, index, and validation views from the result summary">
  <img src="/images/quickstart/03-optimization-result.png" alt="Optimization result: index recommendation, review findings, and performance summary" />
</Frame>
