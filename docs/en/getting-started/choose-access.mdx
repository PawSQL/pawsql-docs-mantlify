...
PawSQL can run as a public cloud service or inside your organization's environment. Its SQL review and optimization capabilities are available through the web console, IDE extensions, APIs, webhooks, and MCP. Choosing the right setup involves two separate decisions: **where PawSQL runs** and **how it fits into your workflow**.
...
- You want to evaluate SQL review, automatic rewriting, and index recommendations immediately.
...
<Tabs>
  ...
  <Tab title="APIs and webhooks">
    ...
    **Use them to:** add SQL review to commits, pull requests, builds, or releases, then trigger notifications, approvals, or quality gates based on the result.
...
<CardGroup cols={2}>
  ...
  <Card title="Explore use cases" icon="diagram-project" href="/en/use-cases">
