...
flowchart TD
    ...
    D --> E[Performance Analysis] --> F["SQL Rewrite<br/>Index Advisor<br/>Plan Analysis"]
...
<Tabs>
  ...
  <Tab title="With PawSQL">
    ...
    ```mermaid
    flowchart TD
        A[Slow SQL] --> B[PawSQL Analysis] --> C[Automated SQL Rewrite] --> D[Automated Index Advisor]
