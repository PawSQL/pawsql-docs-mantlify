...
After the connection passes, the wizard continues to "Slow query config" and "Patrol config" — see [Collect Slow SQL](/en/user-guide/performance/collect-slow-sql) and [Create a Patrol Task](/en/user-guide/performance/patrol-task).
