...
sections:
  ...
  steps: Configure PawSQL MCP
  expectedResult: Review the response
  verification: "3. Reload and verify the connection"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Developer Tool Integration Overview" href="/en/user-guide/dev-tools" icon="code" />
</CardGroup>
