...
<Steps>
  <Step title="Open plugin settings">
    Open **Plugins** from the JetBrains IDE settings.
  </Step>
  <Step title="Find PawSQL">
    Search for **PawSQL Client** or **PawSQL Advisor** and verify the PawSQL publisher.
  </Step>
  <Step title="Install and restart">
    Install the plugin, save open work, and restart the IDE if requested.
  </Step>
  <Step title="Verify the commands">
    Open a SQL file or project directory and confirm that PawSQL Advisor actions appear in the context menu.
  </Step>
</Steps>
