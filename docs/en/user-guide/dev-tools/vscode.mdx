...
<Steps>
  ...
  <Step title="Find PawSQL Client">
    Search for the extension and verify its name, publisher, and listing details.
  </Step>
  <Step title="Install it">
    Install the extension and reload the editor window if requested.
  </Step>
  <Step title="Verify activation">
    Open a file containing SQL and confirm that a PawSQL optimization action appears near the detected statement.
  </Step>
</Steps>
...
<Frame caption="Optimize action next to a SQL statement">
  Screenshot placeholder · /images/dev-tools/vscode-optimize.png
</Frame>
