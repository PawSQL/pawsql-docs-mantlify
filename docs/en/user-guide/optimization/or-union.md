...
> Status: draft content for the new documentation site. See the [optimizer rule reference](en/reference/optimizer-rules/opt-or-union) for the canonical rule page.
