---
id: en-optimizer-rule-opt-distinct-skew-optimization-in-hive
title: DISTINCT Skew Optimization in Hive
type: reference
status: draft
owners: []
entityRef:
...
- optimizer-rule
- rewrite
localeOf: optimizer-rule-opt-distinct-skew-optimization-in-hive
subtype: rule
language: en
...
| Field | Value |
|---|---|
| Rule ID | opt-distinct-skew-optimization-in-hive |
| Name | DISTINCT Skew Optimization in Hive |
