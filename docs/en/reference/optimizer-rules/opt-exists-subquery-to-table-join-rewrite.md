---
id: en-optimizer-rule-opt-exists-subquery-to-table-join-rewrite
...
entityRef:
  type: rule
  id: opt-exists-subquery-to-table-join-rewrite
tags:
- optimizer-rule
- rewrite
...
localeOf: optimizer-rule-opt-exists-subquery-to-table-join-rewrite
subtype: rule
language: en
translationKey: optimizer-rule-opt-exists-subquery-to-table-join-rewrite
layout: detail
product: pawsql
---
...
| Field | Value |
|---|---|
| Rule ID | opt-exists-subquery-to-table-join-rewrite |
