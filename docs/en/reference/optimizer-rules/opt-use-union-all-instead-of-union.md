---
id: en-optimizer-rule-opt-use-union-all-instead-of-union
...
localeOf: optimizer-rule-opt-use-union-all-instead-of-union
subtype: rule
language: en
...
| Field | Value |
|---|---|
| Rule ID | opt-use-union-all-instead-of-union |
