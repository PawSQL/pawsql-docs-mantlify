---
id: en-optimizer-rule-opt-npe-rewrite-null-pointer-exception-prevention
...
entityRef:
  type: rule
  id: opt-npe-rewrite-null-pointer-exception-prevention
tags:
- optimizer-rule
- rewrite
...
localeOf: optimizer-rule-opt-npe-rewrite-null-pointer-exception-prevention
subtype: rule
language: en
translationKey: optimizer-rule-opt-npe-rewrite-null-pointer-exception-prevention
layout: detail
product: pawsql
---
...
| Field | Value |
|---|---|
| Rule ID | opt-npe-rewrite-null-pointer-exception-prevention |
