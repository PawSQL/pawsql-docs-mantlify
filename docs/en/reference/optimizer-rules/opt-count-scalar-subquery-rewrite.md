---
id: en-optimizer-rule-opt-count-scalar-subquery-rewrite
...
entityRef:
  type: rule
  id: opt-count-scalar-subquery-rewrite
tags:
- optimizer-rule
- rewrite
...
localeOf: optimizer-rule-opt-count-scalar-subquery-rewrite
subtype: rule
language: en
translationKey: optimizer-rule-opt-count-scalar-subquery-rewrite
layout: detail
product: pawsql
---
...
| Field | Value |
|---|---|
| Rule ID | opt-count-scalar-subquery-rewrite |
