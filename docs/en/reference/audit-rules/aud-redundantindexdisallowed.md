---
id: en-audit-rule-aud-redundantindexdisallowed
...
entityRef:
  type: rule
  id: aud-redundantindexdisallowed
tags:
- audit-rule
- index
- mysql
...
localeOf: audit-rule-aud-redundantindexdisallowed
subtype: rule
language: en
translationKey: audit-rule-aud-redundantindexdisallowed
layout: detail
product: pawsql
---
...
| Field | Value |
|---|---|
| Rule ID | aud-redundantindexdisallowed |
