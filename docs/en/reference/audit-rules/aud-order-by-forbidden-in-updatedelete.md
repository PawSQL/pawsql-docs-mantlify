---
id: en-audit-rule-aud-order-by-forbidden-in-updatedelete
...
entityRef:
  type: rule
  id: aud-order-by-forbidden-in-updatedelete
tags:
- audit-rule
- dml
...
localeOf: audit-rule-aud-order-by-forbidden-in-updatedelete
subtype: rule
language: en
translationKey: audit-rule-aud-order-by-forbidden-in-updatedelete
layout: detail
product: pawsql
---
...
| Field | Value |
|---|---|
| Rule ID | aud-order-by-forbidden-in-updatedelete |
