---
id: en-audit-rule-aud-insert-must-include-primary-key-column
...
entityRef:
  type: rule
  id: aud-insert-must-include-primary-key-column
tags:
- audit-rule
- dml
...
localeOf: audit-rule-aud-insert-must-include-primary-key-column
subtype: rule
language: en
translationKey: audit-rule-aud-insert-must-include-primary-key-column
layout: detail
product: pawsql
---
...
| Field | Value |
|---|---|
| Rule ID | aud-insert-must-include-primary-key-column |
