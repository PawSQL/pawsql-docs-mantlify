---
id: en-audit-rule-aud-char-column-length-exceeds-threshold
...
entityRef:
  type: rule
  id: aud-char-column-length-exceeds-threshold
tags:
- audit-rule
- ddl
...
localeOf: audit-rule-aud-char-column-length-exceeds-threshold
subtype: rule
language: en
translationKey: audit-rule-aud-char-column-length-exceeds-threshold
layout: detail
product: pawsql
---
...
| Field | Value |
|---|---|
| Rule ID | aud-char-column-length-exceeds-threshold |
