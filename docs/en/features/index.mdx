...
The two play different roles: **Performance Validation answers "is it better?"** — it compares plans and cost before and after, and produces a judgment you can rely on. **Execution Plan Visualization answers "what does the plan look like?"** — it renders plan structure and metrics so you can locate bottlenecks and understand what changed. One produces the verdict, the other the evidence.
...
<CardGroup cols={2}>
  <Card title="SQL Quality Gate" icon="shield-check" href="/en/features/sql-quality-gate">
...
<CardGroup cols={2}>
  ...
  <Card title="PawSQL MCP" icon="bot" href="/en/user-guide/installation/pawsql-mcp">
    Let AI coding assistants call SQL review and optimization.
  </Card>
