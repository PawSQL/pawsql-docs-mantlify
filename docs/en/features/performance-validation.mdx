...
<Note>
This page focuses on **comparison and judgment** — whether the optimized SQL is actually better. For **visual rendering of plans and bottleneck location**, see [Execution Plan Visualization](/en/features/execution-plan-visualization).
</Note>
