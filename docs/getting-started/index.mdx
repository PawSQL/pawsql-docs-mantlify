...
<CardGroup cols={2}>
  ...
  <Card title="查询重写优化" icon="git-compare" href="/reference/optimizer-rules/index">
  ...
  <Card title="执行计划可视化" icon="list-tree" href="/features/execution-plan-visualization">
...
<CardGroup cols={2}>
  ...
  <Card title="优化算法目录" icon="git-compare" href="/reference/optimizer-rules/index">
    了解查询改写的判定依据。
  </Card>
