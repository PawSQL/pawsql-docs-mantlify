...
> 注：以上为历史快照，确切的支持范围以[数据库兼容性矩阵](reference/compatibility/index)为准，待产品复核。

## 阅读路线

- [三步完成您的 SQL 优化](zh/user-guide/cloud/quickstart) —— 创建工作空间、输入待优化 SQL、创建查询优化。
- [优化结果解析](zh/user-guide/cloud/results) —— 优化详情、SQL 比对与执行计划比对。
