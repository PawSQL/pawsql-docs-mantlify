...
flowchart TD
    ...
    D --> E[Performance Risk Analysis] --> F[Target Database Metadata] --> G["SQL Rewrite / Index Advisor"]
    G --> H[Execution Plan Analysis] --> I[Migration Validation] --> J[Release]
```
...
```mermaid
flowchart TD
    A[Migration] --> B[PawSQL Analysis] --> C[Performance Validation] --> D[Fix] --> E[Production]
```
...
flowchart TD
    ...
    subgraph P2["Migration"]
        B1[SQL Conversion] --> B2[SQL Rewrite] --> B3[Index Redesign] --> B4[Plan Validation]
    end
