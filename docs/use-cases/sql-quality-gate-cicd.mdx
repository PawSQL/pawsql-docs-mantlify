...
flowchart TD
    ...
    C --> D[PawSQL SQL Review] --> E[SQL Policy Evaluation]
    E --> F{PASS / BLOCK}
    F -->|PASS| G[Merge]
    F -->|BLOCK| H[Fix SQL]
```
...
PawSQL 帮助企业把 SQL Review 从 Manual Approval 升级为：
...
<CardGroup cols={2}>
  <Card title="了解 PawSQL SQL Review" icon="list-check" href="/features/sql-review">
    在 CI/CD 中审核 SQL 规范、安全与性能风险。
  </Card>
  <Card title="了解 SQL Optimization" icon="wand-sparkles" href="/features/automatic-sql-rewrite">
    自动生成等价的 SQL 重写与索引建议。
  </Card>
