...
<CardGroup cols={2}>
  <Card title="Automatic SQL Rewrite" icon="git-compare" href="/features/automatic-sql-rewrite">
    自动生成语义等价的 SQL 重写方案。
  </Card>
  <Card title="Index Recommendation" icon="scan-search" href="/features/index-recommendation">
    根据查询访问模式推荐候选索引。
  </Card>
...
[了解 Batch SQL Governance →](/use-cases/slow-sql-optimization)
...
<CardGroup cols={2}>
  ...
  <Card title="PawSQL MCP" icon="bot" href="/user-guide/installation/pawsql-mcp">
    让 AI 编程助手调用 SQL 审核与优化能力。
  </Card>
