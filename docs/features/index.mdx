...
<CardGroup cols={2}>
  ...
  <Card title="Execution Plan Analysis" icon="list-tree" href="/features/execution-plan-visualization">
    把文本执行计划还原为可视化执行树。
  </Card>
</CardGroup>

两者分工不同：**Performance Validation 回答"是否更好"**——比较优化前后的执行计划与代价，给出可采信的判定；**Execution Plan Analysis 回答"计划长什么样"**——呈现计划结构与指标，用于定位瓶颈与理解变化。前者产出结论，后者提供依据。
...
<CardGroup cols={2}>
  <Card title="SQL Quality Gate" icon="shield-check" href="/features/sql-quality-gate">
