...
<Steps>
  <Step title="获取官方插件">
    从 PawSQL 官方发布渠道获取插件，并阅读随版本提供的 `INSTALL.md` 或安装说明。
  </Step>
  <Step title="在 DBeaver 中完成安装">
    按安装说明添加插件或更新站点。只信任经过核验的 PawSQL 发布包和签名信息。
  </Step>
  <Step title="重启 DBeaver">
    保存未完成的编辑内容，按提示重启客户端。
  </Step>
  <Step title="确认插件可用">
    打开偏好设置，确认可以看到 **PawSQL Client** 配置项。
  </Step>
</Steps>
...
<Frame caption="偏好设置中的 PawSQL Client 配置">
  截图占位符 · /images/dev-tools/dbeaver-preferences.png
</Frame>
...
<Frame caption="执行前审核的风险提示">
  截图占位符 · /images/dev-tools/dbeaver-review.png
</Frame>
